...
class _LoginScreenState extends State<LoginScreen> {
  ...
  final TextEditingController wrongPasswordText = new TextEditingController();
  final TextEditingController wrongEmailText = new TextEditingController();
  // firebase
    ...
    if (_formKey.currentState!.validate()){
      try {
        ...
        if (newUser != null) {
          ...
          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => HomeScreen(currentIndex: 0,)));
        }else{
        }
