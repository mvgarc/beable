    ...
    FirebaseFirestore.instance
      ...
      .then((value){
        this.loggedInUser = UserModel.fromMap(value.data());
          ...
          context.read<loginFormInfo>().setTexts2(firstName : loggedInUser.firstName);
          ...
          context.read<loginFormInfo>().setTexts5(donwloadURL : loggedInUser.donwloadURL);
          context.read<loginFormInfo>().setTexts6(levelTest : loggedInUser.levelTest);
          context.read<loginFormInfo>().setTexts7(notification : loggedInUser.notification);
        setState((){});
