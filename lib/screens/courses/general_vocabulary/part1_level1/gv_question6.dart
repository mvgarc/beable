...
class gvquestion6 extends StatefulWidget {
  gvquestion6({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question6/gv_question6.png',
            fit: BoxFit.contain),
                  ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Young", audio: 'general_vocabulary/part1_level1/question6/young.mp3'),
              customRadioBorder(2, text: "Old", audio: 'general_vocabulary/part1_level1/question6/old.mp3'),  
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "School", audio: 'general_vocabulary/part1_level1/question6/school.mp3'),
              customRadioBorder(4, text: "Home", audio: 'general_vocabulary/part1_level1/question6/home.mp3'),
            ],
          ),
        ],
    );
