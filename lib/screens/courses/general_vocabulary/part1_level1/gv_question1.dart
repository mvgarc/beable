...
class gvquestion1 extends StatefulWidget {
  gvquestion1({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question1/gv_question1.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Pay", audio: 'general_vocabulary/part1_level1/question1/pay.mp3'),
              customRadioBorder(2, text: "Sully", audio: 'general_vocabulary/part1_level1/question1/sully.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Phase", audio: 'general_vocabulary/part1_level1/question1/phase.mp3'),
              customRadioBorder(4, text: "Trundle", audio: 'general_vocabulary/part1_level1/question1/trundle.mp3'),
            ],
          ),
        ],
    );
