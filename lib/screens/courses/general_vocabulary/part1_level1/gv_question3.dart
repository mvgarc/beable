...
class gvquestion3 extends StatefulWidget {
  gvquestion3({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question3/gv_question3.png',
            fit: BoxFit.contain),
                  ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Make", audio: 'general_vocabulary/part1_level1/question3/make.mp3'),
              customRadioBorder(2, text: "Cheap", audio: 'general_vocabulary/part1_level1/question3/cheap.mp3'),  
              ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Funny", audio: 'general_vocabulary/part1_level1/question3/funny.mp3'),
              customRadioBorder(4, text: "Weird", audio: 'general_vocabulary/part1_level1/question3/weird.mp3'),
            ],
          ),
        ],
