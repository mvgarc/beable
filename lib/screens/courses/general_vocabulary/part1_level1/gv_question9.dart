    ...
    return Column(
      children: <Widget>[
        SizedBox(
          height: 200,
          child: Image.asset(
              'assets/general_vocabulary/part1_level1/question9/gv_question9.png',
              fit: BoxFit.contain),
        ),
        Title(
          color: Colors.black,
        ...
        Row(
          ...
          children: [
            customRadioBorder(1,
                text: "Giraffe",
                audio: 'general_vocabulary/part1_level1/question9/giraffe.mp3'),
            customRadioBorder(2,
                text: "Wolf",
                audio: 'general_vocabulary/part1_level1/question9/wolf.mp3'),
          ],
        ),
        SizedBox(height: 20),
        Row(
          ...
          children: [
            customRadioBorder(3,
                text: "Hen",
                audio: 'general_vocabulary/part1_level1/question9/hen.mp3'),
            customRadioBorder(4,
                text: "Dog",
                audio: 'general_vocabulary/part1_level1/question9/dog.mp3'),
          ],
        ),
      ],
    );
