...
class gvquestion5 extends StatefulWidget {
  gvquestion5({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question5/gv_question5.png',
            fit: BoxFit.contain),
                  ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Dumb", audio: 'general_vocabulary/part1_level1/question5/dumb.mp3'),
              customRadioBorder(2, text: "Close", audio: 'general_vocabulary/part1_level1/question5/close.mp3'),  
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Dirty", audio: 'general_vocabulary/part1_level1/question5/dirty.mp3'),
              customRadioBorder(4, text: "Big", audio: 'general_vocabulary/part1_level1/question5/big.mp3'),
            ],
          ),
        ],
    );
