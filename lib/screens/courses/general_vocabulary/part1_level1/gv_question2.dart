...
class gvquestion2 extends StatefulWidget {
  gvquestion2({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question2/gv_question2.png',
            fit: BoxFit.contain),
                  ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Fat", audio:  "general_vocabulary/part1_level1/question2/fat.mp3"),
              customRadioBorder(2, text: "Sweet", audio: "general_vocabulary/part1_level1/question2/sweet.mp3"), 
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Bitter", audio:"general_vocabulary/part1_level1/question2/bitter.mp3" ),
              customRadioBorder(4, text: "Happy", audio:"general_vocabulary/part1_level1/question2/happy.mp3" ),
            ],
          ),       
        ],
    );
