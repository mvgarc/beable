...
class gvquestion8 extends StatefulWidget {
  gvquestion8({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/general_vocabulary/part1_level1/question8/gv_question8.png',
            fit: BoxFit.contain),
                  ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Fish", audio: 'general_vocabulary/part1_level1/question8/fish.mp3'),
              customRadioBorder(2, text: "Pig", audio: 'general_vocabulary/part1_level1/question8/pig.mp3'), 
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Elephant", audio: 'general_vocabulary/part1_level1/question8/elephant.mp3'),
              customRadioBorder(4, text: "Parrot", audio: 'general_vocabulary/part1_level1/question8/parrot.mp3'),
            ],
          ),
        ],
    );
