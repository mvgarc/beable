    ...
    return Column(
      children: <Widget>[
        SizedBox(
          height: 200,
          child: Image.asset(
              'assets/general_vocabulary/part1_level1/question7/gv_question7.png',
              fit: BoxFit.contain),
        ),
        Title(
          color: Colors.black,
        ...
        Row(
          ...
          children: [
            customRadioBorder(1,
                text: "Cow",
                audio: 'general_vocabulary/part1_level1/question7/cow.mp3'),
            customRadioBorder(2,
                text: "Bird",
                audio: 'general_vocabulary/part1_level1/question7/bird.mp3'),
          ],
        ),
        SizedBox(height: 20),
        Row(
          ...
          children: [
            customRadioBorder(3,
                text: "Chicken",
                audio: 'general_vocabulary/part1_level1/question7/chicken.mp3'),
            customRadioBorder(4,
                text: "Sheep",
                audio: 'general_vocabulary/part1_level1/question7/sheep.mp3'),
          ],
        ),
      ],
    );
