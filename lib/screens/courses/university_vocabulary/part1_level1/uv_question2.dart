    ...
    return Column(
      children: <Widget>[
        SizedBox(
          height: 200,
          child: Image.asset(
              'assets/university_vocabulary/part1_level1/question2/uv_question2.png',
              fit: BoxFit.contain),
        ),
        Title(
          color: Colors.black,
        ...
        Row(
          ...
          children: [
            customRadioBorder(1,
                text: "Allegory",
                audio:
                    'university_vocabulary/part1_level1/question2/allegory.mp3'),
            customRadioBorder(2,
                text: "Bursary",
                audio:
                    'university_vocabulary/part1_level1/question2/bursary.mp3'),
          ],
        ),
        SizedBox(height: 20),
        Row(
          ...
          children: [
            customRadioBorder(3,
                text: "Certificate",
                audio:
                    'university_vocabulary/part1_level1/question2/certificate.mp3'),
            customRadioBorder(4,
                text: "Quarter",
                audio:
                    'university_vocabulary/part1_level1/question2/quarter.mp3'),
          ],
        ),
      ],
    );
