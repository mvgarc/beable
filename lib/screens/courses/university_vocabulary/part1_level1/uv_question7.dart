...
class uvquestion7 extends StatefulWidget {
  uvquestion7({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/university_vocabulary/part1_level1/question7/uv_question7.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Essay", audio: 'university_vocabulary/part1_level1/question7/essay.mp3'),
              customRadioBorder(2, text: "Story", audio: 'university_vocabulary/part1_level1/question7/story.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Report", audio: 'university_vocabulary/part1_level1/question7/report.mp3'),
              customRadioBorder(4, text: "Binary", audio: 'university_vocabulary/part1_level1/question7/binary.mp3'),
            ],
          ),
        ],
    );
