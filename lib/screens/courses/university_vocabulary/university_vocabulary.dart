...
class university_vocabulary extends StatefulWidget {
  university_vocabulary({Key? key}) : super(key: key);
...
class _university_vocabularyState extends State<university_vocabulary> {
  @override
    ...
    var size = MediaQuery.of(context).size;
     ...
     return Scaffold(
      appBar: AppBar(
        title: Text("Vocabulario Universitario", 
          style: TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.bold, 
            fontSize:20, ),), 
                ...
                itemBuilder: (context, index) {
                  return Container(
                    child: Column(
                      ...
                      children: <Widget>[
                        levelcustom(context, level: 'Nivel 1', img: 'part2_level1.png', link: uv_level1()),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            levelcustom(context, level: 'Nivel 2', img: 'part2_level2.png', link: uv_level1()),
                            levelcustom(context, level: 'Nivel 3', img: 'part2_level3.png', link: uv_level1()),
                          ],
                        ),
                        sectionCustom(context, level: 'Sección 1', img: 'section2.png', link: uv_level1()),
                        levelcustom(context, level: 'Nivel 1', img: 'part3_level1.png', link: uv_level1()),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            levelcustom(context, level: 'Nivel 2', img: 'part3_level2.png', link: uv_level1()),
                            levelcustom(context, level: 'Nivel 3', img: 'part3_level3.png', link: uv_level1()),
                          ],
                        ),
                        sectionCustom(context, level: 'Sección 2', img: 'section3.png', link: uv_level1()),
                        levelcustom(context, level: 'Nivel 1', img: 'part1_level1.png', link: uv_level1()),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                            levelcustom(context, level: 'Nivel 2', img: 'part1_level2.png', link: uv_level1()),
                            levelcustom(context, level: 'Nivel 3', img: 'part1_level3.png', link: uv_level1()),
                          ],
                        ),
                        sectionCustom(context, level: 'Sección 3', img: 'section1.png', link: uv_level1()),
