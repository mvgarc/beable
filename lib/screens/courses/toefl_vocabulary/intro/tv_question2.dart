  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/toefl_vocabulary/intro/question2/tv_question2.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Strain", audio: 'toefl_vocabulary/intro/question2/strain.mp3'),
              customRadioBorder(2, text: "Stress", audio: 'toefl_vocabulary/intro/question2/stress.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Adamant", audio: 'toefl_vocabulary/intro/question2/adamant.mp3'),
              customRadioBorder(4, text: "Gloss", audio: 'toefl_vocabulary/intro/question2/gloss.mp3'),
            ],
          ),
        ],
    );
