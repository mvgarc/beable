...
class tvquestion6 extends StatefulWidget {
  tvquestion6({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/toefl_vocabulary/intro/question6/tv_question6.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Joyful", audio: 'toefl_vocabulary/intro/question6/joyful.mp3'),
              customRadioBorder(2, text: "Bland", audio: 'toefl_vocabulary/intro/question6/bland.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Outdo", audio: 'toefl_vocabulary/intro/question6/outdo.mp3'),
              customRadioBorder(4, text: "Miracle", audio: 'toefl_vocabulary/intro/question6/miracle.mp3'),
            ],
          ),
        ],
    );
