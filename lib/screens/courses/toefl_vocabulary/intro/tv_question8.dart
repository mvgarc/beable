...
class tvquestion8 extends StatefulWidget {
  tvquestion8({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/toefl_vocabulary/intro/question8/tv_question8.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Slaughter", audio: 'toefl_vocabulary/intro/question8/slaughter.mp3'),
              customRadioBorder(2, text: "Undertake", audio: 'toefl_vocabulary/intro/question8/undertake.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Entice", audio: 'toefl_vocabulary/intro/question8/entice.mp3'),
              customRadioBorder(4, text: "Squander", audio: 'toefl_vocabulary/intro/question8/squander.mp3'),
            ],
          ),
        ],
    );
