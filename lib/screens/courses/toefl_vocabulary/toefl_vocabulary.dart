...
class toefl_vocabulary extends StatefulWidget {
  toefl_vocabulary({Key? key}) : super(key: key);

  @override
  State<toefl_vocabulary> createState() => _toefl_vocabularyState();
}
...
class _toefl_vocabularyState extends State<toefl_vocabulary> {
  @override
              ...
              itemBuilder: (context, index) {
                return Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      sectionCustom(context, level: 'Inicio', img: 'intro.png', link: tv_intro()),
                      levelcustom(context, level: 'Nivel 1', img: 'part2_level1.png', link: tv_part1_level1()),
                      Row(
                      ...
                      sectionCustom(context, level: 'Sección 1', img: 'section2.png', link: tv_intro()),
                      ...
                      sectionCustom(context, level: 'Sección 2', img: 'section1.png', link: tv_intro()),
                      ...
                      sectionCustom(context, level: 'Sección 3', img: 'section3.png', link: tv_intro()),
