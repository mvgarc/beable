...
class kitchen_vocabulary extends StatefulWidget {
  kitchen_vocabulary({Key? key}) : super(key: key);
...
class _kitchen_vocabularyState extends State<kitchen_vocabulary> {
  @override
    ...
    var size = MediaQuery.of(context).size;
     ...
     return Scaffold(
      appBar: AppBar(
        title: Text("Vocabulario de Cocina", 
          style: TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.bold, 
            fontSize:20, ),), 
                  ...
                  return Container(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        levelcustom(context, level: 'Nivel 1', img: 'part2_level1.png', link: tv_intro()),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
                        ...
                        sectionCustom(context, level: 'Sección 3', img: 'section2.png', link: tv_intro()),
