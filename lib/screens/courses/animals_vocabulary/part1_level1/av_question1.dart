    ...
    return Column(
      children: <Widget>[
        SizedBox(
          height: 200,
          child: Image.asset(
              'assets/animals_vocabulary/part1_level1/question1/av_question1.png',
              fit: BoxFit.contain),
        ),
        Title(
          color: Colors.black,
        ...
        Row(
          ...
          children: [
            customRadioBorder(1,
                text: "Dove",
                audio: 'animals_vocabulary/part1_level1/question1/dove.mp3'),
            customRadioBorder(2,
                text: "Lion",
                audio: 'animals_vocabulary/part1_level1/question1/lion.mp3'),
          ],
        ),
        SizedBox(height: 20),
        Row(
          ...
          children: [
            customRadioBorder(3,
                text: "Snail",
                audio: 'animals_vocabulary/part1_level1/question1/snail.mp3'),
            customRadioBorder(4,
                text: "Ostrich",
                audio: 'animals_vocabulary/part1_level1/question1/ostrich.mp3'),
          ],
        ),
      ],
    );
