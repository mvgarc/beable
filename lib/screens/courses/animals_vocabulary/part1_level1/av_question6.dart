    ...
    return Column(
      children: <Widget>[
        SizedBox(
          height: 200,
          child: Image.asset(
              'assets/animals_vocabulary/part1_level1/question6/av_question6.png',
              fit: BoxFit.contain),
        ),
        Title(
          color: Colors.black,
        ...
        Row(
          ...
          children: [
            customRadioBorder(1,
                text: "Lobster",
                audio: 'animals_vocabulary/part1_level1/question6/lobster.mp3'),
            customRadioBorder(2,
                text: "Crayfish",
                audio:
                    'animals_vocabulary/part1_level1/question6/crayfish.mp3'),
          ],
        ),
        SizedBox(height: 20),
        Row(
          ...
          children: [
            customRadioBorder(3,
                text: "Foal",
                audio: 'animals_vocabulary/part1_level1/question6/foal.mp3'),
            customRadioBorder(4,
                text: "Starfish",
                audio:
                    'animals_vocabulary/part1_level1/question6/starfish.mp3'),
          ],
        ),
      ],
    );
