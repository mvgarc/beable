...
class avquestion9 extends StatefulWidget {
  avquestion9({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/animals_vocabulary/part1_level1/question9/av_question9.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Piglet", audio: 'animals_vocabulary/part1_level1/question9/piglet.mp3'),
              customRadioBorder(2, text: "Seal", audio: 'animals_vocabulary/part1_level1/question9/seal.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Pig", audio: 'animals_vocabulary/part1_level1/question9/pig.mp3'),
              customRadioBorder(4, text: "Owl", audio: 'animals_vocabulary/part1_level1/question9/owl.mp3'),
            ],
          ),
        ],
    );
