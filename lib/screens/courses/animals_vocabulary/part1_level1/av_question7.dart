...
class avquestion7 extends StatefulWidget {
  avquestion7({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/animals_vocabulary/part1_level1/question7/av_question7.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Swan", audio: 'animals_vocabulary/part1_level1/question7/swan.mp3'),
              customRadioBorder(2, text: "Crab", audio: 'animals_vocabulary/part1_level1/question7/crab.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Otter", audio: 'animals_vocabulary/part1_level1/question7/otter.mp3'),
              customRadioBorder(4, text: "Bat", audio: 'animals_vocabulary/part1_level1/question7/bat.mp3'),
            ],
          ),
        ],
    );
