...
class avquestion5 extends StatefulWidget {
  avquestion5({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
        children: <Widget>[
          SizedBox(
            height: 200,
            child: Image.asset('assets/animals_vocabulary/part1_level1/question5/av_question5.png',
            fit: BoxFit.contain),
          ),
          Title(
            color: Colors.black, 
          ...
          Row(
            ...
            children: [
              customRadioBorder(1, text: "Deer", audio: 'animals_vocabulary/part1_level1/question5/deer.mp3'),
              customRadioBorder(2, text: "Hen", audio: 'animals_vocabulary/part1_level1/question5/hen.mp3'),    
            ],
          ),
          SizedBox(height: 20),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              customRadioBorder(3, text: "Dog", audio: 'animals_vocabulary/part1_level1/question5/dog.mp3'),
              customRadioBorder(4, text: "Nightingale", audio: 'animals_vocabulary/part1_level1/question5/nightingale.mp3'),
            ],
          ),
        ],
    );
