                    ...
                    GestureDetector(
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/general_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
                    ...
                    GestureDetector(
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/toefl_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
                    ...
                    GestureDetector(
                      onTap: (() {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => university_vocabulary()));
                      }),
                      child: Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/university_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
                    ...
                    GestureDetector(
                      onTap: (() {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => animals_vocabulary()));
                      }),
                      child: Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/animals_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
                    ...
                    GestureDetector(
                      onTap: (() {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => kitchen_vocabulary()));
                      }),
                      child: Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/kitchen_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
                    ...
                    GestureDetector(
                      onTap: (() {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => program_vocabulary()));
                      }),
                      child: Card(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(8),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            SvgPicture.asset(
                              'assets/courses/program_vocabulary.svg',
                              height: 128,
                            ),
                            SizedBox(
                              height: 5,
