class GvCoursesModel{
  ...
  GvCoursesModel({this.uid, this.part1_level1 = 0, this.part1_level2 = 0, this.part1_level3 = 0,});

  // receiving data from server
  factory GvCoursesModel.fromMap(map){
    return GvCoursesModel(
      uid: map['uid'],
